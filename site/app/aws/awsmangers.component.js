(function () {
    ...
    app.component('awsmangers', {
        templateUrl: 'app/aws/awsmangers.template.html',
        controller: AwsmangerController,
        bindings: {
            portfolios: '<',
    ...
    function AwsmangerController(usersService, $scope, sharedValues, $http) {
       ...
       // $("#divContainer").animate({ scrollTop: this.scroll }, "fast");
        ...
        function _UpdateParam(portfolio) {
            ...
            usersService.getPortfolios(portfolio.llx, portfolio.lly, portfolio.urx, portfolio.ury, portfolio.Word, portfolio.Font, portfolio.Space, portfolio.Id, this.pageNumber).then(function (res) {
